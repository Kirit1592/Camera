...
public class StartingActivity extends Activity implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * Camera state: Waiting for the picture to be needed.
     */
